...
function EventCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-#8493D3 text-black border border-gray-300 shadow-lg overflow-hidden transform transition-all duration-200 ease-in-out group-hover:scale-105 aspect-[3/4]`}
      >
