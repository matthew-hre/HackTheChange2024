...
import { LucideIcon, Calendar, MapPin, Link } from "lucide-react";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundColor: `#${random(event.causes[0] || event.id)
            .toString(16)
            .slice(2, 8)}`,
        }}
      >
      ...
      <div
        className={`bg-blue-100 text-black border border-gray-300 shadow-lg overflow-hidden transform transition-all duration-200 ease-in-out group-hover:scale-105 aspect-[3/4]`}
      >
        <div className={`relative h-full grid grid-rows-[auto_1fr_auto] p-4 gap-4`}>
          ...
          <div className="space-y-2 text-sm sm:text-base">
            ...
            <EventDetail Icon={Link} text={`Source: ${event.source}`} />
          </div>
